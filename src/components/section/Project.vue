  ...
  data() {
    return {
      project: [
        ...
        {
          img: 'src/assets/image/project/pravang_web.jpg',
          alt: '프라뱅 반응형 웹',
          name: '프라뱅 반응형 웹',
        ...
        {
          img: 'src/assets/image/project/muskdas.png',
          alt: '무스크다스',
          name: '무스크다스',
          dec: '금거래소 ',
        ...
        {
          img: 'src/assets/image/project/coincident.png',
        ...
        {
          img: 'src/assets/image/project/time.png',
          alt: '시간을 건너는 편지',
          name: '시간을 건너는 편지',
        ...
        {
          img: 'src/assets/image/project/vpn.png',
          alt: 'VPN 구독 서비스',
          name: 'VPN 구독 서비스 ',
        ...
        {
          img: 'src/assets/image/project/daki.jpg',
          alt: '다키스토어',
          name: '다키스토어',
        ...
        {
          img: 'src/assets/image/project/lemon.jpg',
          alt: '레몬 앱소개 페이지',
          name: '레몬 앱소개 페이지',
        ...
        {
          img: 'src/assets/image/project/jimsa.jpg',
          alt: '짐싸 이벤트 랜딩페이지',
          name: '짐싸 이벤트 랜딩페이지',
          dec: '반응형 이벤트 페이지',
        ...
        {
          img: 'src/assets/image/project/bn.png',
          alt: '비엔시스템 서비스 페이지',
          name: '비엔시스템 서비스 리뉴얼',
          dec: '자사 서비스 페이지 리뉴얼',
